...
@section('mainbody')
        <div class="col-md-12 toggle-bar"><h3 id="artist-name" class="panel-heading"></h3><em class="btn float-right icon dripicons-view-thumb" title="Full Size Panel View"></em><em class="btn float-right icon dripicons-view-list-large"  title="Compact View"></em>
