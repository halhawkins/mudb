...
@section('script')
    <script>
        ...
        $(document).ready(function(){
            $(".new-releases-menu, .top200-menu").removeClass("active");
...
@section('mainbody')
            <div class="col-md-12 toggle-bar"><h3 id="tracks-heading" class="panel-heading">Spotify Viral 50</h3><div class="toggle-panel"></div>
